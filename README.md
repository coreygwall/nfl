...
| **Picks** | This week's five — and once they are in, how they are going: each game's score from your side, what is banked, what is still to play for, where that leaves you. The lock screen's Live Activity, drawn large, on both surfaces. |
